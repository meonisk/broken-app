...
где их можно перезапустить и сверить с логами во вкладке Actions. Шаблоны
`scripts/profile.sh` и `scripts/compare.sh` из исходного архива по этой же
причине не пригодились: их заменили два workflow.
